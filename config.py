...
class Config:
    ...
    UPDATE_CHECK_TIMEOUT_SECONDS = _env_int('UPDATE_CHECK_TIMEOUT_SECONDS', 20)
    UPDATE_DOWNLOAD_TIMEOUT_SECONDS = _env_int('UPDATE_DOWNLOAD_TIMEOUT_SECONDS', 60)
    UPDATE_NETWORK_RETRY_ATTEMPTS = _env_int('UPDATE_NETWORK_RETRY_ATTEMPTS', 3)
    UPDATE_NETWORK_RETRY_BACKOFF_SECONDS = _env_int('UPDATE_NETWORK_RETRY_BACKOFF_SECONDS', 2)
