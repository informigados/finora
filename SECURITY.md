...
- 🔄 Desktop updates require HTTPS and a matching SHA-256 checksum before the installer is staged; source updates retain protected ZIP extraction and migration handling.
...
- 🧾 Public release automation produces SHA-256 checksums, release metadata, an update manifest, and a GitHub provenance attestation.
